<p align="center">
  <a href="https://github.com/zhangxguang/DHDesk"><img src="assets/desktop-hero-en.png" alt="DHDesk, an open-source desktop client built on DeepSeek Harness" width="100%"></a>
</p>

<h1 align="center">DHDesk</h1>

<p align="center">
  <strong>An open-source desktop client for Windows and macOS, built on DeepSeek Harness.</strong>
</p>

<h3 align="center"><a href="https://github.com/zhangxguang/DHDesk">One-click download, ready to use out of the box.</a></h3>
...
<p align="center">
  <img src="assets/desktop-chat-en.png" alt="DHDesk chat interface in English" width="100%">
</p>

<p align="center">
  <a href="https://github.com/zhangxguang/DHDesk/releases/latest"><img src="https://img.shields.io/github/v/release/zhangxguang/DHDesk?style=flat&amp;label=release&amp;color=4D6BFE" alt="Latest release"></a>
  <a href="https://github.com/zhangxguang/DHDesk/releases"><img src="https://img.shields.io/github/downloads/zhangxguang/DHDesk/total?style=flat&amp;label=downloads&amp;color=4D6BFE" alt="Total downloads"></a>
  <a href="https://github.com/zhangxguang/DHDesk"><img src="https://img.shields.io/github/stars/zhangxguang/DHDesk?style=flat&amp;label=%E2%98%85&amp;color=08C" alt="GitHub stars"></a>
...
DHDesk integrates the local Web UI, Host service, and plugin system from [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) into a native desktop application. It runs a pinned upstream version unchanged, while DHDesk provides the window, tray, terminal, updates, and work profiles through the plugin mechanism provided by DeepSeek Harness.
...
| --- | --- | --- |
| Windows x64 | [Download installer](https://github.com/zhangxguang/DHDesk/releases/latest) | Run the NSIS installer and follow its prompts |
| macOS Universal | [Download DMG](https://github.com/zhangxguang/DHDesk/releases/latest) | Open the DMG and drag DHDesk into Applications |
...
| Understand why the project exists | [Why DHDesk](docs/why-desktop.en.md) |
...
<table>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>The DSH plugin ecosystem is built by the community. Upstream plugins, DHDesk plugins, and other community plugins follow shared conventions and can work together through the same composition mechanism. Join us — read the <a href="docs/plugin-ecosystem.en.md">DSH plugin ecosystem manifesto</a>.</p>
    </td>
  </tr>
</table>
...
The automatic updater's fixed version-check request sends the installed version in the `X-DHDesk-Version` header and a locally generated, persistently stored random UUID in the `X-DHDesk-Installation-Id` header; the value is not derived from hardware information. Package download requests and their download redirects do not receive these headers.
...
The upstream project provides the core agent capabilities, plugin system, and Web UI. DHDesk primarily provides:
...
Special thanks to the [original DeepSeek Harness repository](https://github.com/deepseek-ai/deepseek-harness) and the DeepSeek AI team. DHDesk is built from a pinned upstream checkout, and its core agents, models, tools, sessions, Web UI, and plugin ecosystem come from that project.

We also thank [Cordis](https://github.com/cordiverse/cordis) for the plugin foundation that makes this composition possible. DHDesk would not exist without these open-source projects.
...
<table>
  ...
  <tbody>
    <tr>
      <td align="center"><img src="assets/community-wechat-group.png" alt="DHDesk WeCom QR code" title="Scan to add us on WeCom" width="180" height="180"></td>
      <td align="center"><img src="assets/community-qq-group.jpg" alt="DHDesk QQ group QR code" width="180" height="180"></td>
    </tr>
  </tbody>
</table>

Discord: [Join the DHDesk community](https://discord.gg/TJeGqKRNM)
...
<sub>To list your project, join the WeChat group and message @王博升Benson, or contact t4wefan@qq.com, or <a href="https://github.com/zhangxguang/DHDesk/issues">open an issue</a>.</sub>
...
> DHDesk is an independent community project and is not affiliated with, sponsored by, authorized by, or endorsed by DeepSeek.

## Star History

<a href="https://www.star-history.com/?repos=zhangxguang%2FDHDesk&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=zhangxguang/DHDesk&type=date&theme=dark&legend=top-left&sealed_token=BRTkOyC4czCEkIyFb5-QxrsC-kaDotBJ8tsjxrWs-UGfmBqfRCXSwieZPlVTCYOjJVEZ29uLvmBjAPREB524J5dPN1jk-UA7ajFdLdrbjumJqoOBeGWmig" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=zhangxguang/DHDesk&type=date&legend=top-left&sealed_token=BRTkOyC4czCEkIyFb5-QxrsC-kaDotBJ8tsjxrWs-UGfmBqfRCXSwieZPlVTCYOjJVEZ29uLvmBjAPREB524J5dPN1jk-UA7ajFdLdrbjumJqoOBeGWmig" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=zhangxguang/DHDesk&type=date&legend=top-left&sealed_token=BRTkOyC4czCEkIyFb5-QxrsC-kaDotBJ8tsjxrWs-UGfmBqfRCXSwieZPlVTCYOjJVEZ29uLvmBjAPREB524J5dPN1jk-UA7ajFdLdrbjumJqoOBeGWmig" />
 </picture>
</a>
