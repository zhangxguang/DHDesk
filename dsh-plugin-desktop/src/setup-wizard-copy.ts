...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    title: 'Set up DHDesk',
    profile: 'Profile',
    welcomeTitle: 'Welcome to DHDesk',
    ...
    communityMarketBody: 'The open market built into DHDesk, including custom data sources.',
  ...
  zh: {
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'DHDesk 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
