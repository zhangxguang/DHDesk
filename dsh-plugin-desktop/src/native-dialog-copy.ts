...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    dismiss: 'Dismiss',
    updateAvailableTitle: 'DHDesk Update Available',
    updateAvailableMessage: version => `DHDesk ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside DHDesk Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'Could not retrieve update information.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'DHDesk Is Up to Date',
    ...
    updateDownloadedTitle: 'DHDesk Update Downloaded',
    updateReady: version => `DHDesk ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace DHDesk in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart DHDesk and run the installer now?',
    ...
    updateInstalled: version => `DHDesk ${version} has been installed.`,
  ...
  zh: {
    ...
    restart: '重启 DHDesk',
    dismiss: '关闭',
    updateAvailableTitle: 'DHDesk 有可用更新',
    updateAvailableMessage: version => `DHDesk ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？DHDesk Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: '未能获取更新信息。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'DHDesk 已是最新版本',
    upToDateMessage: '当前已是最新版本。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '当前版本不支持在应用内下载安装包。',
    updateDownloadedTitle: 'DHDesk 更新已下载',
    updateReady: version => `DHDesk ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 DHDesk，然后重新打开。',
    windowsInstallQuestion: '现在重启 DHDesk 并运行安装程序？',
    ...
    updateInstalled: version => `DHDesk ${version} 已安装。`,
