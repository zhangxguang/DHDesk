...
const rawPlugin = {
  id: 'zhangxguang/DHDesk/dsh-plugin-desktop',
  name: 'deepseek-harness-desktop',
  owner: 'anywhere-labs',
  url: 'https://github.com/zhangxguang/DHDesk',
  category: 'dev',
...
describe('1024Store adapter', () => {
  ...
  it('projects reviewed fields and never forwards remote install strings', async () => {
    ...
    expect(snapshot.items[0]).toMatchObject({
      ...
      media: { icon: { assetRef: publisherAssetRef, role: 'publisher-avatar', alt: 'zhangxguang' } },
    ...
    expect(register).toHaveBeenCalledWith({
      remoteUrl: 'https://github.com/zhangxguang.png?size=96',
