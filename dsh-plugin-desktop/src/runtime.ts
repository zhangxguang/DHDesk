...
/** Electron platforms supported by the DHDesk native adapter. */
...
export interface DesktopUpdateAdapter {
  ...
  /** Release stream selected by this packaged product. Stable adapters omit this field. */
  ...
  downloadAndOpen(version: string, signal: AbortSignal, channel?: DesktopReleaseChannel, artifactUrl?: string, artifactDigest?: string): Promise<void>
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    /** Electron adapter provided by the DHDesk launcher. */
