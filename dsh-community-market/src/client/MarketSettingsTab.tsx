...
const INSTALL_REQUIREMENTS_DOCS = {
  en: 'https://github.com/zhangxguang/DHDesk/blob/master/dsh-community-market/docs/install-and-uninstall.md',
  zh: 'https://github.com/zhangxguang/DHDesk/blob/master/dsh-community-market/docs/install-and-uninstall.zh.md',
} as const
const CATALOG_ADAPTER_GUIDE_DOCS = {
  en: 'https://github.com/zhangxguang/DHDesk/blob/master/dsh-community-market/docs/catalog-adapter-guide.md',
  zh: 'https://github.com/zhangxguang/DHDesk/blob/master/dsh-community-market/docs/catalog-adapter-guide.zh.md',
} as const
const DSH_DESKTOP_ISSUES_URL = 'https://github.com/zhangxguang/DHDesk/issues'
