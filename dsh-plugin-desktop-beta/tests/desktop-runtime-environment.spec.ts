...
function options(
  ...
  return {
    ...
    appExecutable: platform === 'win32'
      ? 'C:\\Program Files\\DSH 100% Desktop\\DHDesk.exe'
      : "/Applications/DSH O'Brien.app/Contents/MacOS/DHDesk",
    pnpmBinPath: platform === 'win32'
      ? 'C:\\Program Files\\DHDesk\\resources\\app.asar.unpacked\\node_modules\\pnpm\\bin\\pnpm.mjs'
...
describe('desktop Host dsh runtime', () => {
  it('content-addresses Windows DSH shims and reuses an exact generation', () => {
    ...
    const runtimeOptions = {
      ...
      appExecutable: 'C:\\Program Files\\DHDesk\\DHDesk.exe',
      dshBootstrapPath: 'C:\\Program Files\\DHDesk\\resources\\app.asar\\desktop-cli.js',
      profileName: 'web',
