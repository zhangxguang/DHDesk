...
describe('packaged dsh bootstrap', () => {
  ...
  it('clears Node mode and dispatches the imported CLI exactly once', async () => {
    ...
    const argv = ['/Applications/DHDesk', '/app.asar/lib/desktop-cli.js', '--dump-config']
  ...
  it('uses the physical unpacked dependency tree only inside an Electron package', () => {
    expect(unpackedAsarPath('/Applications/DHDesk.app/Contents/Resources/app.asar/node_modules/pkg'))
      .toBe('/Applications/DHDesk.app/Contents/Resources/app.asar.unpacked/node_modules/pkg')
    expect(unpackedAsarPath('C:\\Program Files\\DHDesk\\resources\\app.asar\\node_modules\\pkg'))
      .toBe('C:\\Program Files\\DHDesk\\resources\\app.asar.unpacked\\node_modules\\pkg')
    expect(unpackedAsarPath('/Applications/DHDesk.app/Contents/Resources/app.asar/package.json'))
      .toBe('/Applications/DHDesk.app/Contents/Resources/app.asar.unpacked/package.json')
